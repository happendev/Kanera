  ...
  template: `
    ...
    <section class="panel">
      <div class="panel-head">
        ...
        <button class="btn btn-danger" type="button" [disabled]="loading() || resetting()" (click)="reset()">
          @if (resetting()) {
      ...
      <section class="panel credentials">
        <div class="panel-head">
          <div>
            ...
            <p class="muted">The password is generated securely and shown only in this reset result. Save it now.</p>
          </div>
...
export class DemoPage implements OnInit {
  ...
  async reset(): Promise<void> {
    ...
    try {
      const created = await this.api.post<AdminDemoResetResponse>("/admin/demo/reset");
