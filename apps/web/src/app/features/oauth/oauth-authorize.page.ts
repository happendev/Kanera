...
@Component({
  ...
  styles: [`
    ...
    .consent-card { width: min(480px, 100%); border: 1px solid var(--border); border-radius: 12px; padding: 2rem; background: var(--card); box-shadow: var(--shadow-lg); }
    @media (max-width: 480px) { .consent-card { padding: 1.25rem; } .actions { flex-direction: column; align-items: stretch; } }
