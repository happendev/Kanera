...
/**
 * The normalized client-side filter shared by board and global-work pages and driven
...
export interface FilterValue {
  labelIds: string[];
  /** Assignee filter; Global Work can constrain this implicitly through its active lens. */
  memberIds: string[];
  listIds: string[];
  /** Board filter for cross-board views; always `[]` on a single-board page. */
  boardIds: string[];
