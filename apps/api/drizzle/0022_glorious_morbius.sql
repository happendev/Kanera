...
ALTER TABLE "support_session" ADD COLUMN "admin_email" text;--> statement-breakpoint
UPDATE "support_session" SET "admin_email" = "superadmin_email";--> statement-breakpoint
ALTER TABLE "support_session" ALTER COLUMN "admin_email" SET NOT NULL;--> statement-breakpoint
