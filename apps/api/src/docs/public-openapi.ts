...
export const publicOpenApiDocument: Record<string, unknown> = {
  ...
  components: {
    ...
    schemas: {
      ...
      Checklist: {
        type: "object",
        required: ["id", "cardId", "title", "position", "items"],
        properties: { id: uuid, cardId: uuid, title: { type: "string" }, position, items: arrayOf(ref("ChecklistItem")) },
        additionalProperties: true,
      },
      ChecklistItem: {
        type: "object",
        required: ["id", "checklistId", "text", "completed", "position"],
        properties: { id: uuid, checklistId: uuid, text: { type: "string" }, assigneeId: nullable(uuid), completed: { type: "boolean" }, position },
        additionalProperties: true,
      },
      Note: {
        type: "object",
      ...
      Comment: {
        type: "object",
        required: ["id", "cardId", "body", "createdAt", "updatedAt"],
        properties: {
          id: uuid,
          cardId: uuid,
          authorId: uuid,
  ...
  paths: {
    ...
    "/lists/{id}/cards/move": pathItem("post", operation({ tags: ["Lists"], summary: "Move cards between lists in bulk", operationId: "moveListCards", parameters: [idParam()], requestBody: jsonBody(ref("MoveListCardsBody")), responses: authedResponses({ "200": ok(arrayOf(ref("Card"))) }) })),
    "/lists/{id}/cards/archive": pathItem("patch", operation({ tags: ["Lists"], summary: "Archive or restore cards in a list", operationId: "archiveListCards", parameters: [idParam()], requestBody: jsonBody(ref("SetCardArchivedBody")), responses: authedResponses({ "200": ok(arrayOf(ref("Card"))) }) })),
    ...
    "/boards/{boardId}/lists/{id}/cards/completion": pathItem("post", operation({ tags: ["Cards"], summary: "Set completion for all cards in a list", operationId: "setListCardCompletion", parameters: [idParam("boardId"), idParam("id", "List id.")], requestBody: jsonBody(ref("SetCardCompletionBody")), responses: authedResponses({ "200": ok(arrayOf(ref("Card"))) }) })),
    ...
    "/cards/{id}/checklists": pathItem("post", operation({ tags: ["Cards"], summary: "Create a card checklist", operationId: "createChecklist", parameters: [idParam()], requestBody: jsonBody(ref("CreateChecklistBody")), responses: authedResponses({ "201": created(ref("Checklist")) }) })),
    ...
    "/cards/{id}/checklists/{checklistId}/items/{itemId}": {
      patch: operation({ tags: ["Cards"], summary: "Update a checklist item", operationId: "updateChecklistItem", parameters: [idParam(), idParam("checklistId"), idParam("itemId")], requestBody: jsonBody(ref("UpdateChecklistItemBody")), responses: authedResponses({ "200": ok(ref("ChecklistItem")) }) }),
